  ...
  const definition = defineBackground(() => {
    ...
    browser$2.runtime.onInstalled.addListener(async (details) => {
      ...
      if (details.reason === "install") {
        ...
        try {
          await browser$2.runtime.openOptionsPage();
        } catch (error) {
