  ...
  const definition = defineUnlistedScript(() => {
    ...
    onMessage("dbExec", async (message) => {
      ...
      try {
        ...
        const result2 = await dbInstance.exec(sql, params || []);
