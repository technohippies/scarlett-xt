...
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
  ...
  const definition = defineContentScript({
    ...
    async main(_ctx) {
      ...
      onMessage("_requestSelectionFromContentScript", async (_message) => {
        var _a2;
      ...
      browser$2.runtime.onMessage.addListener((message, _sender, sendResponse) => {
