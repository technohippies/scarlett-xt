...
export {}
declare global {
  const Button: typeof import('/media/xo42/th427/Code/scarlett-wxt-storybook/components/Button')['Button']
  const ContentScriptContext: typeof import('wxt/utils/content-script-context')['ContentScriptContext']
  const InvalidMatchPattern: typeof import('wxt/utils/match-patterns')['InvalidMatchPattern']
  const Large: typeof import('/media/xo42/th427/Code/scarlett-wxt-storybook/components/test-Button.stories')['Large']
  const MatchPattern: typeof import('wxt/utils/match-patterns')['MatchPattern']
  const Primary: typeof import('/media/xo42/th427/Code/scarlett-wxt-storybook/components/test-Button.stories')['Primary']
  const Secondary: typeof import('/media/xo42/th427/Code/scarlett-wxt-storybook/components/test-Button.stories')['Secondary']
  const Small: typeof import('/media/xo42/th427/Code/scarlett-wxt-storybook/components/test-Button.stories')['Small']
  ...
  const testButtonStories: typeof import('/media/xo42/th427/Code/scarlett-wxt-storybook/components/test-Button.stories')['default']
...
declare global {
  ...
  // @ts-ignore
  export type { ButtonProps } from '/media/xo42/th427/Code/scarlett-wxt-storybook/components/Button'
  import('/media/xo42/th427/Code/scarlett-wxt-storybook/components/Button')
}
